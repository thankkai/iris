...
public class EurekaService {
  ...
  public interface Iface {
    ...
    public cn.dazd.iris.core.tchannel.thrift.Result toEureka(cn.dazd.iris.core.tchannel.thrift.HostInfo hostInfo, java.util.List<java.lang.String> endpoints) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void toEureka(cn.dazd.iris.core.tchannel.thrift.HostInfo hostInfo, java.util.List<java.lang.String> endpoints, org.apache.thrift.async.AsyncMethodCallback<cn.dazd.iris.core.tchannel.thrift.Result> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public cn.dazd.iris.core.tchannel.thrift.Result toEureka(cn.dazd.iris.core.tchannel.thrift.HostInfo hostInfo, java.util.List<java.lang.String> endpoints) throws org.apache.thrift.TException
    {
      send_toEureka(hostInfo, endpoints);
      return recv_toEureka();
    }

    public void send_toEureka(cn.dazd.iris.core.tchannel.thrift.HostInfo hostInfo, java.util.List<java.lang.String> endpoints) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void toEureka(cn.dazd.iris.core.tchannel.thrift.HostInfo hostInfo, java.util.List<java.lang.String> endpoints, org.apache.thrift.async.AsyncMethodCallback<cn.dazd.iris.core.tchannel.thrift.Result> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      toEureka_call method_call = new toEureka_call(hostInfo, endpoints, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class toEureka_call extends org.apache.thrift.async.TAsyncMethodCall<cn.dazd.iris.core.tchannel.thrift.Result> {
      ...
      public toEureka_call(cn.dazd.iris.core.tchannel.thrift.HostInfo hostInfo, java.util.List<java.lang.String> endpoints, org.apache.thrift.async.AsyncMethodCallback<cn.dazd.iris.core.tchannel.thrift.Result> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class toEureka<I extends Iface> extends org.apache.thrift.ProcessFunction<I, toEureka_args> {
      ...
      public toEureka_result getResult(I iface, toEureka_args args) throws org.apache.thrift.TException {
        toEureka_result result = new toEureka_result();
        result.success = iface.toEureka(args.hostInfo, args.endpoints);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class toEureka<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, toEureka_args, cn.dazd.iris.core.tchannel.thrift.Result> {
      ...
      public void start(I iface, toEureka_args args, org.apache.thrift.async.AsyncMethodCallback<cn.dazd.iris.core.tchannel.thrift.Result> resultHandler) throws org.apache.thrift.TException {
        iface.toEureka(args.hostInfo, args.endpoints,resultHandler);
      }
    }
  ...
  public static class toEureka_args implements org.apache.thrift.TBase<toEureka_args, toEureka_args._Fields>, java.io.Serializable, Cloneable, Comparable<toEureka_args>   {
    ...
    private java.util.List<java.lang.String> endpoints; // required
    ...
    public toEureka_args setEndpoints(java.util.List<java.lang.String> endpoints) {
      this.endpoints = endpoints;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.endpoints = new java.util.ArrayList<java.lang.String>(_list0.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, toEureka_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.endpoints != null) {
          oprot.writeFieldBegin(ENDPOINTS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter3 : struct.endpoints)
            {
        ...
        if (struct.isSetEndpoints()) {
          {
            ...
            for (java.lang.String _iter4 : struct.endpoints)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.endpoints = new java.util.ArrayList<java.lang.String>(_list5.size);
